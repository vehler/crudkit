...
const examples = [
  ...
  },
  {
    ...
    badge: 'Core',
    difficulty: 'Intermediate',
    features: ['Categories', 'Inventory', 'Bulk Actions', 'Status Management'],
  },
  {
    title: 'Customer Orders',
    description:
      'Order management with status workflows, customer data, and payment tracking.',
    href: '/examples/orders',
    badge: 'Core',
    difficulty: 'Advanced',
    features: ['Relationships', 'Date Filtering', 'Status Workflow', 'Payment Methods'],
  },
  {
    title: 'Blog CMS',
    description:
      'Content management system with draft/publish states, tags, and content organization.',
    href: '/examples/blog',
    badge: 'Core',
    difficulty: 'Intermediate',
    features: ['Draft/Publish', 'Categories', 'Tags', 'Scheduling'],
  },
  {
    ...
    badge: 'Core',
    difficulty: 'Beginner',
    features: ['Various Fields', 'Validation', 'Categories', 'Form Handling'],
  },
  {
    title: 'Analytics Dashboard',
    description:
      'Track user behavior, events, and conversion metrics with real-time statistics and filtering.',
    href: '/examples/dashboard',
    badge: 'Core',
    difficulty: 'Intermediate',
    features: ['Event Tracking', 'Geographic Data', 'Revenue Metrics', 'Custom Filters'],
  },
]
