...
import { DefaultFilterInput } from './filter-input'
import type { FilterProps } from '@/lib/crudkit/types'
 ...
 * @example
 * ```typescript
 * import { DefaultFilter } from '@/components/crudkit/components/filters'
